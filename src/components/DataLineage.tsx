const nodes = [
  { id: "sfcc", label: "SFCC Storefront", x: 10, y: 30, color: "hsl(195, 100%, 50%)" },
  { id: "ga4", label: "Google Analytics 4", x: 160, y: 30, color: "hsl(38, 95%, 55%)" },
  { id: "mktgcloud", label: "Marketing Cloud", x: 310, y: 30, color: "hsl(280, 70%, 60%)" },
  { id: "datacloud", label: "Data Cloud", x: 160, y: 120, color: "hsl(195, 100%, 50%)" },
  { id: "einstein", label: "Einstein AI", x: 10, y: 120, color: "hsl(152, 70%, 45%)" },
  { id: "crm", label: "Salesforce CRM", x: 310, y: 120, color: "hsl(38, 95%, 55%)" },
  { id: "agentforce", label: "Agentforce", x: 160, y: 210, color: "hsl(195, 100%, 50%)" },
  { id: "personalize", label: "Personalization", x: 10, y: 210, color: "hsl(280, 70%, 60%)" },
